...
import kotlinx.android.synthetic.main.fragment_e_sign.*
import java.io.File
 ...
 * Use the [ESignFragment.newInstance] factory method to
...
//            val path: File = requireContext()!!.getDatabasePath("")
...
//            signView.save(output)
    ...
    companion object {
         ...
         * @return A new instance of fragment ESignFragment.
         */
