 ...
 * Use the [ApprovalPendingFragment.newInstance] factory method to
...
class ApprovalPendingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findNavController().navigate(R.id.action_approvalPendingFragment_to_approvedFragment)
    }
