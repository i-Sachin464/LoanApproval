...
import com.client.loanapproval.ui.enach.ENachActivity
...
class ThankyouFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        startActivity(Intent(requireContext(), ENachActivity::class.java))
        findNavController().popBackStack(R.id.performKycFragment,false)
    }
