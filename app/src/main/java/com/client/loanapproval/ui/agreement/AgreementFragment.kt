    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_submit.setOnClickListener {
            if (checkbox.isChecked)
                findNavController().navigate(R.id.action_agreementFragment_to_ESignFragment)
            else
                Snackbar.make(it, "Please agree on the term and conditions", Snackbar.LENGTH_SHORT)
                    .show()
        }
